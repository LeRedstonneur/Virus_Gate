...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        ...
        self.tempx = float(x)
        self.tempy = float(y)
        self.path = [(482, 20), (600, 20), (600, 180), (534, 180), (534, 340), (600, 340), (600, 580),(534,580),(534,660),(412,660),(412,420),(148,420),(146,740),(6,740),(6,180),(72,180),(72,260),(402,260),(402,100),(138,100),(138,20)]
...
class Croix(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/croix.png")
        self.speed = 3
...
class GrandeCroix(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/grande_croix.png")
        self.speed = 1
...
class Losange(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/losange2.png")
        self.speed = 1
        self.original_speed = 1
        self.health = 60
        self.max_health = 60
...
class Rectangle(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/rectangle.png")
        self.speed = 1
        ...
        self.shield_image = pygame.transform.scale(pygame.image.load("Assets/Enemies/shield2.png"), (self.shield_radius * 3, self.shield_radius * 3))
...
class Hexagone(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/hexagone.png")
    ...
    def update(self):
        ...
        self.increase_speed()
        self.check_spawn_croix(enemy_group)
        # Mettre à jour le bouclier
        if self.shield_health <= 0 and not self.shield_broken:
            self.shield_health = 0
            self.shield_broken = True
...
class Fleche(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/arrow.png")
        self.speed = 2
        self.original_speed = self.speed
        self.health = 100
        self.max_health = 100
...
class Coeur(Enemy):
    def __init__(self, x, y):
        super().__init__(x, y, path_assets+"/Enemies/coeur.png")
        self.speed = 2
        self.original_speed = self.speed
        self.health = 100
        self.max_health = 100
