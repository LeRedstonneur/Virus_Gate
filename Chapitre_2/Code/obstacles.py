...
pygame.Rect(5250, 510, 80, 20), pygame.Rect(5420, 430, 80, 20), pygame.Rect(5650, 510, 80, 20), pygame.Rect(5880, 590, 80, 20), pygame.Rect(6050, 800, 50, 250)]

towers = [Tower("classique", -600, -600), Tower("degats_de_zone", -1000, -450), Tower("classique", -1900, -1000), Tower("degats_de_zone",-2250, -425), 
Tower("classique", -2740, -935), Tower("classique", -2915, -935), Tower("classique", -3500, -700), Tower("degats_de_zone", -4300, -300),
Tower("degats_de_zone", -5000, -320), Tower("sniper", -5850, -350)]
...
Spike(-5950, -990), Spike(-6000, -990), Spike(-6150, -990)]
